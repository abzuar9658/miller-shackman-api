...
from app.interfaces.api.v1.outbound_send_exceptions import (
    router as outbound_send_exceptions_router,
)
...
api_router.include_router(outbound_send_exceptions_router, prefix="/workspaces")
