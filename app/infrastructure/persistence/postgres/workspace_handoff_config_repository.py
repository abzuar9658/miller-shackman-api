...
def _config_from_model(model: WorkspaceHandoffConfigModel) -> WorkspaceHandoffConfig:
    return WorkspaceHandoffConfig(
        ...
        lead_acknowledgment_sms_enabled=model.lead_acknowledgment_sms_enabled,
        lead_acknowledgment_sms_body=model.lead_acknowledgment_sms_body,
        lead_acknowledgment_email_enabled=model.lead_acknowledgment_email_enabled,
        lead_acknowledgment_email_subject=model.lead_acknowledgment_email_subject,
        lead_acknowledgment_email_body=model.lead_acknowledgment_email_body,
        lead_acknowledgment_prompt_text=model.lead_acknowledgment_prompt_text,
