...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("selected_track_key", sa.String(255), nullable=True),
        sa.Column("track_selection_status", sa.String(50), nullable=True),
        sa.Column("track_version_id", pg.UUID(as_uuid=True), nullable=True),
